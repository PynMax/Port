...
namespace PortAIO.Dual_Port
{
    class Misc
    {
        ...
        public static void Load()
        {
            ...
            utility.AddItem(new MenuItem("DeveloperSharp", "Enable DeveloperSharp?").SetValue(false));
            utility.AddItem(new MenuItem("Spin2Win", "Enable Spin2Win?").SetValue(false));
            utility.AddItem(new MenuItem("IgniteSharp", "Enable IgniteSharp?").SetValue(false));
